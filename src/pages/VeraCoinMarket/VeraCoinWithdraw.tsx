...
import { veraContractAbi, veraContractAddr } from '@/constants/chains'
        ...
        <Box width={{ md: 'auto', xs: '100%' }}>
          ...
          >
            <Typography variant='body2'>
              {isPending ? 'Confirming...' : isConfirming ? 'Waiting for confirmation...' : 'Withraw'}
            </Typography>
          </Button>
        </Box>
      </Box>
...
export default VeraCoinWithdraw
